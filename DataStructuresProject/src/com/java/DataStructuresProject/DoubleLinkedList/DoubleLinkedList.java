package com.java.DataStructuresProject.DoubleLinkedList;
...
public class DoubleLinkedList {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					DoubleLinkedList window = new DoubleLinkedList();
	...
	private void initialize() {
		...
		JLabel lblDoubleLinkedList = new JLabel("DOUBLE LINKED LIST DATA STRUCTURE");
